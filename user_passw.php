...
if ($_POST['confirm_password']=='Change')
{
	...
	$new_confirmation = $_POST['new_password_confirmation'];//get info from form
		if ($old != $password){
			...
			header("Location: user_passw.php?msg=$msg");
			exit();
		}else{
			if ($new != $new_confirmation){
				...
				$sql="UPDATE 1000_investor_information SET password = '$new' WHERE UID = '$UID'";
...
<div class="fright link_marron"><a href="logout.php">Log out</a></div><br />
      ...
      <tr>
          ...
          <img class="img_floatleft" src="images/space.png" />
<div class="btn_120"><span onmouseover="this.style.color='red';" onmouseout="this.style.color='black';"><a class="btn_text_black" href="user_info.php">Main Page</a></span></div>
<br /><br /><hr />
</td>
        </tr>
      <tr>
...
New Password Confirmation:</td>
        ...
        <form method="post" action="user_passw.php" onsubmit='return formValidator()'>
	  ...
	  **************************************************************************/
	  ...
	  ?>  
        ...
        <tr>
          <td height="32" colspan="4" align="left"><hr /></td>
        </tr>
      </table>
